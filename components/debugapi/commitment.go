...
func getSlotTransactionIDs(index iotago.SlotIndex) (*nodeclient.CommitmentDetailsResponse, error) {
...
func getSlotBlockIDs(index iotago.SlotIndex) (*nodeclient.UTXOChangesResponse, error) {
