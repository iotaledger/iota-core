...
type ParametersValidator struct {
	...
	// BroadcastInterval is the interval at which the node broadcasts its validator block.
	BroadcastInterval time.Duration `default:"2s" usage:"the interval at which the node will broadcast its validator block"`
