...
var (
	...
	protocolParamsDockerTest = iotago.NewV3ProtocolParameters(
		iotago.WithNetworkOptions("docker", "rms"),
		iotago.WithSupplyOptions(4_600_000_000_000_000, 250, 1, 1000, 100000, 500000, 100000),
...
var (
	...
	DockerTest = []options.Option[snapshotcreator.Options]{
		snapshotcreator.WithFilePath("docker-network.snapshot"),
		snapshotcreator.WithProtocolParameters(protocolParamsDockerTest),
		snapshotcreator.WithAccounts(
			snapshotcreator.AccountDetails{
				/*
					node-01-validator
