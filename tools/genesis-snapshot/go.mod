...
require (
	...
	github.com/iotaledger/hive.go/core v1.0.0-rc.3.0.20231018114558-3d8598f4b26e // indirect
	github.com/iotaledger/hive.go/ds v0.0.0-20231018114558-3d8598f4b26e // indirect
