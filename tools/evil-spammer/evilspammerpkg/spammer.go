...
func (s *Spammer) PostTransaction(tx *iotago.Transaction, clt evilwallet.Client) {
	if tx == nil {
...
func (s *Spammer) handleSolidityForReuseOutputs(clt evilwallet.Client, tx *iotago.Transaction) (ok bool) {
