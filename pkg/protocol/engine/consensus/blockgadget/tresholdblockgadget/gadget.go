...
type Gadget struct {
	...
	blocks           *memstorage.IndexedStorage[iotago.SlotIndex, models.BlockID, *blockgadget.Block]
...
func New(opts ...options.Option[Gadget]) *Gadget {
	return options.Apply(&Gadget{
		...
		blocks:              memstorage.NewIndexedStorage[iotago.SlotIndex, models.BlockID, *blockgadget.Block](),
