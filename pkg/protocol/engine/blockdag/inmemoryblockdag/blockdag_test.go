...
func TestBlockDAG_MissingBlocks(t *testing.T) {
	...
	tips := randommap.New[iotago.BlockID, iotago.BlockID]()
	...
	blocks := make(map[iotago.BlockID]*models.Block, blockCount)
	...
	tips.ForEach(func(key iotago.BlockID, _ iotago.BlockID) bool {
