...
type TestFramework struct {
	...
	outputIDsByAlias map[string]ledger.OutputID
...
func NewTestFramework(test *testing.T, instance mempool.MemPool) *TestFramework {
	...
	genesisOutput := mockedvm.NewMockedOutput(EmptyTransactionID, 0, 0)
...
func (t *TestFramework) AssertConflictIDs(expectedConflicts map[string][]string) {
	for txAlias, expectedConflictAliases := range expectedConflicts {
		...
		t.ConsumeTransactionMetadata(currentTx.ID(), func(txMetadata *mempool.TransactionMetadata) {
...
func (t *TestFramework) AssertTransactionConfirmationState(txAlias string, validator func(state confirmation.State) bool) {
	t.ConsumeTransactionMetadata(t.Transaction(txAlias).ID(), func(txMetadata *mempool.TransactionMetadata) {
...
func (t *TestFramework) ConsumeTransactionMetadata(txID utxo.TransactionID, consumer func(txMetadata *mempool.TransactionMetadata)) {
...
func (t *TestFramework) ConsumeTransactionOutputs(mockTx *mockedvm.MockedTransaction, consumer func(outputMetadata *OutputMetadata)) {
	t.ConsumeTransactionMetadata(mockTx.ID(), func(txMetadata *mempool.TransactionMetadata) {
