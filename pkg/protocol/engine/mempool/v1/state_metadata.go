...
func (s *StateMetadata) CommittedSpender() (mempool.TransactionMetadata, bool) {
	committedSpender := s.spendCommitted.Get()

	return committedSpender, committedSpender != nil
}
