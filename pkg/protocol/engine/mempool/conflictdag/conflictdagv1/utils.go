...
func heaviestConflict[ConflictID, ResourceID conflictdag.IDType, VoterPower conflictdag.VoteRankType[VoterPower]](conflicts set.Set[*Conflict[ConflictID, ResourceID, VoterPower]]) *Conflict[ConflictID, ResourceID, VoterPower] {
