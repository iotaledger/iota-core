...
func TestEvaluateAgainstRootCommitment(t *testing.T) {
	...
	isBelow, isRootCommitment := m.evaluateAgainstRootCommitment(iotago.NewCommitment(tpkg.TestAPI.Version(), 0, iotago.SlotIdentifierRepresentingData(0, []byte{}), iotago.Identifier{}, 0))
	...
	isBelow, isRootCommitment = m.evaluateAgainstRootCommitment(iotago.NewCommitment(tpkg.TestAPI.Version(), 1, iotago.SlotIdentifierRepresentingData(1, []byte{1}), iotago.Identifier{}, 0))
	require.True(t, isBelow, "commitment with index 1 should be below root commitment")
	require.False(t, isRootCommitment, "commitment with index 1 should be the root commitment")

	isBelow, isRootCommitment = m.evaluateAgainstRootCommitment(iotago.NewCommitment(tpkg.TestAPI.Version(), 1, iotago.SlotIdentifierRepresentingData(1, []byte{9}), iotago.Identifier{}, 0))
	require.True(t, isBelow, "commitment with index 1 should be below root commitment")
	require.True(t, isRootCommitment, "commitment with index 1 should be the root commitment")

	isBelow, isRootCommitment = m.evaluateAgainstRootCommitment(iotago.NewCommitment(tpkg.TestAPI.Version(), 2, iotago.SlotIdentifierRepresentingData(2, []byte{}), iotago.Identifier{}, 0))
