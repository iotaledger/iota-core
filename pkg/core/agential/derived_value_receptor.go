...
func DeriveValueReceptorFrom1Input[ValueType, InputType1 comparable, InputSource1 Value[InputType1]](containingAgent Agent, transformationFunc func(InputType1) ValueType, input1 *InputSource1) *DerivedValueReceptor[ValueType] {
...
func DeriveValueReceptorFrom2Inputs[OutputType, InputType1, InputType2 comparable, InputSource1 Value[InputType1], InputSource2 Value[InputType2]](containingAgent Agent, transitionFunc func(InputType1, InputType2) OutputType, input1 *InputSource1, input2 *InputSource2) *DerivedValueReceptor[OutputType] {
...
func DeriveValueFrom3Inputs[OutputType, InputType1, InputType2, InputType3 comparable, InputReceptorType1 Value[InputType1], InputReceptorType2 Value[InputType2], InputReceptorType3 Value[InputType3]](containingAgent Agent, transitionFunc func(InputType1, InputType2, InputType3) OutputType, input1 *InputReceptorType1, input2 *InputReceptorType2, input3 *InputReceptorType3) *DerivedValueReceptor[OutputType] {
	d := &DerivedValueReceptor[OutputType]{
		ValueReceptor: NewValueReceptor[OutputType](),
	}
