...
func TestManager_Get(t *testing.T) {
	...
	m := NewManager(1, WithGranularity(granularity), WithDBEngine(hivedb.EngineRocksDB), WithBaseDir(baseDir), WithMaxOpenDBs(2))
	...
	m = NewManager(1, WithGranularity(granularity), WithDBEngine(hivedb.EngineRocksDB), WithBaseDir(baseDir))
